 ...
 */
$config['site_title']                 = "myssi.localhost.dev";       // Site Title, example.com
$config['admin_email']                = "admin@localhost.dev"; // Admin Email, admin@example.com
 ...
 */
$config['remember_cookie_name'] = 'myssi_remember_code';
$config['identity_cookie_name'] = 'myssi_identity';
